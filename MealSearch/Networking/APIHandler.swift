...
//    func fetchRecipes() async -> [RecipeModel] {
//        let urlString = "https://api.spoonacular.com/recipes/complexSearch?query=pasta&number=10&addRecipeInformation=true&fillIngredients=true&apiKey=\(self.apiKey)"
//        
